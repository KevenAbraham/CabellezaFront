...
//             <Link to='/Cadastro'><button className={style.button1}>Cadastre-se já</button></Link> 
...
//             <div className={style.btnassinar}>
//             <Link to='/Cadastro'><button className={style.button2}>Cadastre-se já</button></Link> 
...
//             <div className={style.btnassinar}>
//             <Link to='/Cadastro'><button className={style.button3}>Cadastre-se já</button></Link> 
...
//             <div className={style.btnassinar}>
//             <Link to='/Cadastro'><button className={style.button4}>Cadastre-se já</button></Link> 
